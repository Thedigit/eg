...
<%
	...
	*/
    ...
    //*
	gv_APIUserName	= "${PAYPAL.USERID}";
	gv_APIPassword	= "${PAYPAL.PASSWORD}";
	gv_APISignature = "${PAYPAL.SIGNATURE}";
	//APP-ID = APP-8WM21116A3559234K
    //SB APP-ID = APP-80W284485P519543T
    
    boolean bSandbox = ((Boolean) session.getAttribute("staging")).booleanValue();//*/
...
<%!
	...
	*********************************************************************************/
	public HashMap
    httpcall( String methodName, String nvpStr)
	{
