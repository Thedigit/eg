 ...
 * Date: 6/17/12
 * Time: 12:08 PM
 * Support Functions for main products page.
 */
...
function populateAll()
    {
       ...
       for (var j = 0; j <selections.length;j++)
        ...
        // console.log("Preselecting "+(j+1)+" :"+selections[j].val);
         updateBelow($("#"+(j+1)));
        }
    ...
    function init()
    {
       ...
       if(pos){
        ...
        //Product options slide toggle
        $("fieldset.ProductOptions ul li .DropDownCheckbox").click(function(){
           // $("fieldset.ProductOptions ul li div:visible").slideToggle("fast");

            //Reset Sample
            $(".SampleCorner div").removeClass();

            //Toggle each checkbox
            $(this).parent().next().find("input").each(function(checked){
                return function(){
                    $(this).attr("checked",checked);
                    if(checked){
                        $(".SampleCorner div").toggleClass($(this).attr("id"));
                    }
                }
            }($(this).is(":checked")))
        ...
        //Round Corner changer
        $(".ChangeCorner").change(function(){
            $(".SampleCorner div").toggleClass($(this).attr("id"));
        });
